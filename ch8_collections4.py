...
def_dict = defaultdict(constant_factory("<value_unknown>"))  # Generate whatever value is passed in
def_dict.update(name="Mary", action="ran")  # Update dict with new keys
